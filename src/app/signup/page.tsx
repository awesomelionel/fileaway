  ...
  return (
    <div className="min-h-screen bg-[#0d0d0f] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-xl font-semibold text-[#e8e8e8] mb-1">Create account</h1>
        <p className="text-sm text-[#555] mb-7">
          Already have an account?{" "}
          <Link href="/login" className="text-[#888] hover:text-[#ccc] transition-colors underline underline-offset-2">
            Sign in
          </Link>
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3" noValidate>
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-xs text-[#666] mb-1.5">
              Confirm password
            </label>
            <input
              id="confirmPassword"
