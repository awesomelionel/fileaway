...
const styles = StyleSheet.create({
  ...
  tabs: { flexGrow: 0, height: 44, marginBottom: 8 },
  ...
  pillLabel: { fontSize: 14, lineHeight: 18, color: "#ccc", fontWeight: "500" },
  pillActiveLabel: { fontSize: 14, lineHeight: 18, color: "#111", fontWeight: "600" },
